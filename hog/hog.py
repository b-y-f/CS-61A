...
def more_boar(player_score, opponent_score):
    ...
    if player_score < 10: ps.append(player_score)
    if opponent_score < 10: os.append(opponent_score)

    while player_score >0:
        ps.append(player_score%10)
        player_score=player_score//10

    while opponent_score >0:
        os.append(opponent_score%10)
    ...
    return True if min_ps < min_os and max_ps > max_os else False
    # END PROBLEM 4
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        ...
        if score > running_high:
            ...
            print('Player', who, 'has reached a new maximum point gain.', score ,"point(s)!")
            return announce_highest(who,last_score=current_score,running_high=score)   
        else:
            return announce_highest(who,last_score=current_score,running_high=running_high)    
    return say
